...
class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},\n\n ᴍʏ ɴᴀᴍᴇ <a href=https://t.me/{}>{}</a>,\n ɪ'ᴀᴍ ᴀᴅᴠᴀɴᴄᴇᴅ ᴀɴᴅ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ ⁺ ᴍᴀɴᴜᴀʟ ꜰɪᴛᴇʀ ᴀɴᴅ ᴡɪᴛʜ ʙᴇꜱᴛ ᴜɪ ᴘᴇʀꜰᴏʀᴍᴀɴᴄᴇ</b>"""

    HELP_TXT = """<b>Hᴇʏ {}
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""

    ABOUT_TXT = """<b>⍟───[ MY ᴅᴇᴛᴀɪʟꜱ ]───⍟
‣ ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/Lufy_auto_filter_bot>Lufy</a>
 ‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/Professorr_x'>Professorr</a> 
 ‣ ʟɪʙʀᴀʀʏ : <a href='https://docs.pyrogram.org/'>ᴘʏʀᴏɢʀᴀᴍ</a> 
 ‣ ʟᴀɴɢᴜᴀɢᴇ : <a href='https://www.python.org/download/releases/3.0/'>ᴘʏᴛʜᴏɴ 3</a> 
 ‣ ᴅᴀᴛᴀ ʙᴀsᴇ : <a href='https://www.mongodb.com/'>ᴍᴏɴɢᴏ ᴅʙ</a> 
 ‣ ʙᴏᴛ sᴇʀᴠᴇʀ : <a href='https://heroku.com'>Heroku</a> 
 ‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ1.1.8 [sᴛᴀʙʟᴇ]></b>"""

    SOURCE_TXT = """
<b>ʜᴇʏ, ᴛʜɪꜱ ɪꜱ ᴀ ᴘʀɪᴠᴀᴛᴇ ᴘʀᴏᴊᴇᴄᴛ.

Where is source code? - <a href='https://t.me/Professorr_x'>ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ</a></b>


Developer - <a href='https://t.me/Professorr_x'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
...
my features Stay here new features coming soon...  
 <b>✯ Maintained by : <a href=https://t.me/professorr_x>Professorr</a></b>
  
 <b>✯ Join here : <a href=https://t.me/+GlWjH2Zbp-w5YjVl>Join my updates channel</a></b> 
...
Tɪᴘ: Sᴇʟᴇᴄᴛ "Lᴀɴɢᴜᴀɢᴇs" ᴏʀ "Sᴇᴀsᴏɴs" Bᴜᴛᴛᴏɴ ᴀɴᴅ Cʟɪᴄᴋ "Sᴇɴᴅ Aʟʟ" Tᴏ ɢᴇᴛ Aʟʟ Fɪʟᴇ Lɪɴᴋs ɪɴ ᴀ Sɪɴɢʟᴇ ᴄʟɪᴄᴋ"""
    ...
    SINFO = """
𝘿𝙪𝙚 𝙩𝙤 𝙤𝙫𝙚𝙧𝙡𝙤𝙖𝙙 𝙤𝙣𝙡𝙮 𝙤𝙪𝙧 𝙨𝙪𝙗𝙨𝙘𝙧𝙞𝙗𝙚𝙧𝙨 𝙘𝙖𝙣 𝙪𝙨𝙚 𝙩𝙝𝙚 𝙗𝙤𝙩.🥲 """
...
ஏய் <a href='tg://settings'>My Friend</a> 
 ...
 படி 1: இந்த LUFY-AUTO-FILTER-BOT போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>My Friend</a> 
 ...
 Step 1: Administer this LUFY-AUTO-FILTER-BOT bot to your group
...
హే <a href='tg://settings'>My Friend</a> 
 ...
 దశ 1: ఈ LUFY-AUTO-FILTER-BOT బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>My Friend</a> 
 ...
 चरण 1: इस LUFY-AUTO-FILTER-BOT को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>My Friend</a> 
 ...
 ഘട്ടം 1: ഈ LUFY-AUTO-FILTER-BOT ബോട്ട് നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس LUFY-AUTO-FILTER-BOTبوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>My Friend</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ LUFY-AUTO-FILTER-BOT બોટનું સંચાલન કરો
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ಈ LUFY-AUTO-FILTER-BOT ಬೋಟ್ ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
...
আরে <a href='tg://settings'>My Friend</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই LUFY-AUTO-FILTER-BOT বট পরিচালনা করুন
...
-Dev [Owner of this bot ]<a href='https://t.me/professorr_x'>Professorr</a>
