...
PICS = (environ.get('PICS', 'https://graph.org/file/4b3fe544c3f523b44d228.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://te.legra.ph/file/a27dc8fe434e6b846b0f8.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/+PTanCTBATpo3YTg9")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'a64a02b943b7e480caa9f851135f6ab1711dddcc')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/terabox_movie_request_group')
SPRT_CHNL = environ.get('SPRT_CHNL', 'https://t.me/omglinks69')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/omglinks69')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+PTanCTBATpo3YTg9')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'professorr_x')
...
URL = "https://lazypro-46ed2d042752.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://lazypro-46ed2d042752.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://lazypro-46ed2d042752.herokuapp.com/".format(FQDN)
else:
    URL = "https://lazypro-46ed2d042752.herokuapp.com/".format(FQDN)
