...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            return
        buttons = [[
                    InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="https://t.me/terabox_movie_request_group"),
                    InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url="https://t.me/+GlWjH2Zbp-w5YjVl")
                 ],[
                    InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="https://t.me/professorr_x")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('Support Group',url="https://t.me/terabox_movie_request_group"),
            InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="https://t.me/professorr_x")
        ],[
